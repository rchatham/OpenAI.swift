...
public class OpenAI {
    ...
    public func perform<Request: OpenAIRequest>(request: Request, requestCompletionCofig reconfig: @escaping (Request) -> Request? = { return $0 }) async throws -> Request.Response {
    ...
    public func stream<Request: OpenAIRequest>(request: Request, requestCompletionCofig reconfig: @escaping (Request) -> Request? = { return $0 }) -> AsyncThrowingStream<Request.Response, Error> {
